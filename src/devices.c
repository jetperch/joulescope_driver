...
const struct device_type_s device_types[] = {
    ...
    // JS220 updater "{4e6ac43c-b1e7-40fe-b7e8-97093e52dbb2}"
    {JSDRV_DEVICE_TYPE_JS220_BL, "&js220", {0x4e6ac43c, 0xb1e7, 0x40fe, {0xb7, 0xe8, 0x97, 0x09, 0x3e, 0x52, 0xdb, 0xb2}}, 0x16D0, 0x10BA},
