...
// envelope (pubsub 0x040000, trace 0x060000); the ctrl firmware update targets
...
const struct jsdrv_fwup_resource_s JSDRV_FWUP_RESOURCES[] = {
    {"0/0/app/pubsub_metadata.bin", "c/xspi/!cmd",  0x040000, 0x20000},
    {"0/0/app/mbgen.bin",           "c/xspi/!cmd",  0x060000, 0x20000},
