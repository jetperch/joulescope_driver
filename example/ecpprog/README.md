...
A basic driver for MiniBitty JTAG probes to program Lattice ECP5/Nexus FPGAs.

Modified from [ecpprog](https://github.com/gregdavill/ecpprog).
...
- Provide the `-S` option to write to the FPGA SRAM, not the SPI Flash.
- Provide the `-a` option to reboot the FPGA.
